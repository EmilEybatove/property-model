...
namespace Library
{
    namespace Details
    {
        ...
        template <typename T, typename... Ts, typename Tuple1, typename Tuple2, typename Tuple3>
        struct FunctionH<Tuple1, Tuple2, Tuple3, T, Ts...>
        {
            using type = std::function<Type<T, Tuple1, Tuple2, Tuple3>(Type<Ts, Tuple1, Tuple2, Tuple3>...)>;
        };

    }

    template <typename Tuple1, typename Tuple2, typename Tuple3, typename... Ts>
    using Function = typename Details::FunctionH<Tuple1, Tuple2, Tuple3, Ts...>::type;
    ...
    struct Getter<Data<Ind>>
    {
        ...
        static auto &get(std::tuple<DataTypes...> &data, std::tuple<ValueTypes...> &value, std::tuple<OutputTypes...> &output)
        {
